...
class ProductTemplate(models.Model):
    ...
    def _get_combination_info(self, combination=False, product_id=False, add_qty=1, parent_combination=False, only_template=False):
        ...
        rec.update({'default_code':product.default_code,})
        return rec
...
class ProductPerPageCountBizople(models.Model):
    ...
    def create(self, val_list):
        res = super(ProductPerPageCountBizople, self).create(val_list)
...
class ProductPublicCategory(models.Model):
    ...
    category_icon = fields.Binary('Category Icon Image', readonly=False)
